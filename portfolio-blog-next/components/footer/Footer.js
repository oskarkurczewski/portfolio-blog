      ...
      <div className='footer'>
          <div className='contact'>
            ...
            <a className='contact-way' href="mailto:oskarkuczewskifotografia@gmail.com">
              <img src="/square-envelope-solid.svg" alt="envelope" width={22} height={22}/>
              <p>oskarkurczewskifotografia@gmail.com</p>
            </a>
            <a className='contact-way' href="tel:604558300">
              <img src="/phone-square-alt-solid.svg" alt="telephone" width={22} height={22}/>
              <p>604 558 300</p>
            </a>
          </div>
          ...
          <div className='socials'>
            ...
            <div className='icons'>
              <a href="https://www.instagram.com/oskarkurczewski/" target="_blank">
                <img src="/square-instagram.svg" alt="instagram logo" width={28} height={28}/>
              </a>
              <a href="https://www.facebook.com/oskarkurczewskifotografia" target="_blank">
                <img src="/square-facebook.svg" alt="facebook logo" width={28} height={28}/>
              </a>
              <a href="https://github.com/oskarkurczewski" target="_blank">
                <img src="/square-github.svg" alt="github logo" width={28} height={28}/>
              </a>
            </div>
          </div>
      </div>
